					...
					<div class="content">
						<div id="owl-slide" class="owl-carousel">
							<div class="item">
								...
								<div class="carousel-caption">
									<div class="carousel-caption-inner">
										<p class="carousel-caption-title"><a href="https://travelearth.cu.ma/calculator">Калькулятор на JavaScript</a></p>
							...
							<div class="item">
								...
								<div class="carousel-caption">
									<div class="carousel-caption-inner">
										<p class="carousel-caption-title"><a href="https://travelearth.cu.ma/google_maps_api">Google Maps OpenWeather APIs</a></p>
							...
							<div class="item">
								...
								<div class="carousel-caption">
									<div class="carousel-caption-inner">
										<p class="carousel-caption-title"><a href="https://travelearth.cu.ma/conference">Conference Web site</a></p>
...
<footer id="footer">
	<div class="zerogrid wrap-footer">
		...
		<div class="bottom-footer">
			<div class="copyright">
				Copyright @ TravelEarth - Designed by Serguz | <a href="https://www.facebook.com/sergiy.shevchenko.16" title="TravelEarth - Free Travel Idea">TravelEarth</a>
			</div>
		</div>
	</div>
